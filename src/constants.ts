export const BLOG_TITLE = "The JS Developer";
export const COLOR_THEME_COOKIE_NAME = "color-theme";
export const BLOG_DESCRIPTION = "Blog of a growing web developer";

type Colors = Record<string, string>;
export const LIGHT_COLORS: Colors = {
  "--color-text": "hsl(0deg 0% 5%)",
  "--color-primary-100": "hsl(45deg 90% 88%)",
  "--color-primary-300": "hsl(43deg 90% 75%)",
  "--color-primary-500": "hsl(50deg 100% 60%)",
  "--color-primary-700": "hsl(42deg 63% 48%)",
  "--color-primary-900": "hsl(43deg 77% 27%)",
...
LIGHT_COLORS["--color-backdrop"] = LIGHT_COLORS["--color-gray-0"];
...
DARK_COLORS["--color-backdrop"] = DARK_COLORS["--color-gray-0"];
...
export const LIGHT_SHADOWS: Record<string, string> = {
  "--shadow-page": `
